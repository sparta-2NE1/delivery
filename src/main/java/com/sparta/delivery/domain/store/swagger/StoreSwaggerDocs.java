...
public @interface StoreSwaggerDocs {
    ...
    @Parameter(name = "storeId", description = "수정할 가게의 UUID", required = true, example = "af2a560c-1512-4912-97ce-02f9afce72aa")
    @ApiResponses({
    ...
    @Parameter(name = "storeId", description = "삭제할 가게의 UUID", required = true, example = "af2a560c-1512-4912-97ce-02f9afce72aa")
    @ApiResponses({
